...
class ContactTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        liveQuery = instanceOfCouchModel.retrieveData()
    ...
    @IBAction func importContacts() {
        ...
        let instanceOfImportContacts = ImportContacts()
        let contacts = instanceOfImportContacts.importContactsFromAddressBook()
        instanceOfCouchModel.fillModelObject(contacts as [AnyObject])
